                ...
                return function(scope, iElement, iAttributes, containerCtrl) {
                    ...
                    if (iAttributes.rnCarouselIndex) {
                        ...
                        if (angular.isFunction(indexModel.assign)) {
                            ...
                            scope.$watch('carouselIndex', function(newValue) {
                                indexModel.assign(scope.$parent.$parent, newValue);
                            });
                    ...
                    // !!EDIT by ijse: Callback with some info when swiping
                    if (iAttributes.rnSwipeCallback) {
                        var swipeCallbackModel = $parse(iAttributes.rnSwipeCallback);
                        if (angular.isFunction(swipeCallbackModel.assign)) {
                            swipeCallback = swipeCallbackModel(scope);
                        }
                    }
